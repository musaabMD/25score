...
// //       </div>
// //     </div>
// //     <span className="hidden md:block text-xl font-bold text-gray-800 ml-2">Scoorly</span>
// //   </Link>
// // );

// // const HomeHeader = () => {
// //   return (
// //     <header className="fixed top-0 left-0 right-0 bg-white border-gray-200 z-50">
...
//                   <AuthButtons />
//                 ) : (
//                   /* Show ButtonAccount if user is logged in */
...
// //                   <AuthButtons />
// //                 ) : (
// //                   /* Show navigation items if user is logged in */
